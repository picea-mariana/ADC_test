...
```
Everything above the --- is in yaml (yet another markup language)
You could also use:
author: ["Julia Stuart, jms2435@nau.edu","Bryce Mecum, mecum@nceas.ucsb.edu"]

You can add a csl file to make it cite in a certain fashion i. e. Nature
csl: biomed_central.csl (download a file and match it to the csl name in the header)

#Abstract
There is a package to do something with citations: look at bib file `citr`
...
#kable is a good package for printed tables
...
#References
No matter which citation manager you use you can get it to export into .bib
Which is text, which is best
